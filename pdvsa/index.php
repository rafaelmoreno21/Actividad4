  ...
  <div class="container my-5">
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        <p class="lead">Esta aplicación sirve para recolectar la información de las mediciones realizadas de las válvulas PSI de diferentes pozos petroleros de la empresa PDVSA ubicados en varias zonas del país.</p> <br>
